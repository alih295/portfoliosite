...
function HerSection() {
   return (
      <div className='w-full lg:gap-0 h-screen  gap-10 z-10 relative lg:px-10 lg:mt-40  flex  lg:flex-row flex-col items-center justify-start lg:justify-center mt-10 font-[myFont]'>
